...
- qubesos, it is even more secure than chromeos (except lack of verified boot, heads is ok),
...
- there is shell exploits, can easily bypass the fake "sandboxing" flatpak does 
